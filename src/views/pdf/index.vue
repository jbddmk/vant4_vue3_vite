<template>
    ...
    <!--    触控区-->
    <!--    个人章-->
    <div class="sign"  data-type="1" data-id="user-id-001" :style="{width:personalImgWScale+'px',height:personalImgHScale+'px'}">
    ...
    <footer>
        ...
        <button class="toolbarButton save" title="save" id="save">保存</button>
    </footer>
</template>
